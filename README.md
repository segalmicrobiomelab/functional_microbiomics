# Functional microbiomic approaches using lower airway samples identify a subset of lung microbial communities with evidence of active microbial metabolism
*Manuscript Analysis*
